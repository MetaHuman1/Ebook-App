...
<div class="container p-3">
    <div class="row ">
        ...
        <div class="col-md-6 p-5 text-center border bg-white">
            ...
            <h5 class="text-primary"><i class="far fa-envelope"></i> Email: <%=b.getUserEmail()%>
            </h5>
            <% }
            %>
            ...
            <div class="text-center p-3">
                ...
                <a href="" class="btn btn-danger"><%=b.getPrice()%><i class="fas fa-ruble-sign"></i></a>
            </div>
            <% } else {%>
            <div class="text-center p-3">
                <a href="" class="btn btn-primary"><i class="fas fa-cart-plus"></i> Add Cart</a>
                <a href="" class="btn btn-danger ml-1"><%=b.getPrice()%><i class="fas fa-ruble-sign"></i></a>
            </div>
            <%
                }
            %>
